	            ...
	            return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                "{",
	                                _react2.default.createElement("br", null),
	                                "    console.log('JS changed scroll position', details)",
	                                _react2.default.createElement("br", null),
	                                "}",
	                                ");"
	                            ),
	                            ...
	                            _react2.default.createElement(
	                                "a",
	                                { href: "https://github.com/mattzeunert/javascript-breakpoint-collection/blob/master/console-api.md", target: "_blank" },
	                                "Learn more"
	                            )
	                        ),
	                        _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: "col-content" },
	                        _react2.default.createElement(_AvailableBreakpointsList2.default, {
	                            search: this.state.availableBreakpointsListSearchString,
	                            breakpoints: _app.appState.predefinedBreakpoints })
	                    )
	                ),
	                _react2.default.createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.updateBreakpointType = updateBreakpointType;
	...
	function updateBreakpointType(breakpoint, traceOrDebugger) {
	    var id = breakpoint.id;
	    var code = "window.breakpoints.__internal.updateBreakpointType('" + id + "', '" + traceOrDebugger + "');";
	    evalInInspectedWindow(code);
	}
	
	function setTypeOfMostRecentBreakpointToDebugger() {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(AvailableBreakpointsListItem, [{
	        ...
	        value: function render() {
	            ...
	            if (this.props.recentlyActivated) {
	                convertToDebuggerTypeButton = _react2.default.createElement(
	                    "div",
	                    { style: {
	                            float: "right",
	                            background: "red",
	...
	var AvailableBreakpointsList = function (_React$Component2) {
	    ...
	    function AvailableBreakpointsList(props) {
	        _classCallCheck(this, AvailableBreakpointsList);
	
	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(AvailableBreakpointsList).call(this, props));
	    ...
	    _createClass(AvailableBreakpointsList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                null,
	                this.getBreakpointsToShow().map(function (bp) {
	                    var recentlyActivated = bp === _this4.state.recentlyActivatedBreakpoint;
	                    return _react2.default.createElement(AvailableBreakpointsListItem, {
	                        key: bp.title,
	                        recentlyActivated: recentlyActivated,
	                        onMouseLeave: function onMouseLeave() {
	                            if (_this4.state.recentlyActivatedBreakpoint !== null) {
	                                _this4.setState({ recentlyActivatedBreakpoint: null });
	                            }
	                        },
	                        onClick: function onClick() {
	                            if (recentlyActivated) {
	                                (0, _app.setTypeOfMostRecentBreakpointToDebugger)();
	                                _this4.setState({ recentlyActivatedBreakpoint: null });
	                            } else {
	                                (0, _app.activateBreakpoint)(bp);
	                                _this4.setState({ recentlyActivatedBreakpoint: bp });
	                            }
	                        },
	                        breakpoint: bp });
	                })
	        ...
	        key: "getBreakpointsToShow",
	        value: function getBreakpointsToShow() {
	            var _this5 = this;
	
	            return this.props.breakpoints.filter(function (breakpoint) {
	                return breakpoint.title.toLowerCase().indexOf(_this5.props.search.toLowerCase()) > -1;
	            });
	        }
	    }]);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    {
	                        className: "delete",
	                        "data-test-marker-delete-bp": true,
	                        onClick: function onClick() {
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { style: { marginTop: 4 } },
	                    _react2.default.createElement(_BreakpointTypeSelector2.default, {
	                        value: this.props.breakpoint.details.type,
	                        onChange: function onChange(breakpointType) {
	                            return (0, _app.updateBreakpointType)(_this2.props.breakpoint, breakpointType);
	                        } })
	                )
	            );
	        }
	    ...
	    _createClass(ActiveBreakpointsList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                null,
	                this.props.breakpoints.map(function (bp, i) {
	                    return _react2.default.createElement(ActiveBreakpointsListItem, { key: i, breakpoint: bp });
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BreakpointTypeSelector = function (_React$Component) {
	    _inherits(BreakpointTypeSelector, _React$Component);
	
	    function BreakpointTypeSelector() {
	        _classCallCheck(this, BreakpointTypeSelector);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BreakpointTypeSelector).apply(this, arguments));
	    }
	
	    _createClass(BreakpointTypeSelector, [{
	        key: "render",
	        value: function render() {
	            var _this2 = this;
	            ...
	            return _react2.default.createElement(
	                ...
	                options.map(function (option, i) {
	                    var isSelected = _this2.props.value === option;
	                    return _react2.default.createElement(
	                        "div",
	                        {
	                            key: i,
